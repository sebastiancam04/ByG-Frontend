...
// 🎨 MAPEO DE COLORES (Ajustado a tu Enum de C#)
const getStatusBadge = (estado: string) => {
  switch (estado) {
    case "Pendiente":
      return "bg-yellow-500 hover:bg-yellow-600";
    case "EnRevision": // Antes "En Preparación"
      return "bg-purple-500 hover:bg-purple-600";
    case "AprobadaBodega": // Antes "Aprobada"
      return "bg-blue-600 hover:bg-blue-700";
    case "RequiereCompra":
        return "bg-orange-500 hover:bg-orange-600";
    case "Finalizada": // Antes "Entregada"
...
// Función para mostrar el nombre "bonito" al humano, aunque el valor interno sea técnico
...
export default function PedidosBodegaPage() {
  ...
  // 2. Cargar Detalle (Al abrir modal)
      ...
      <div className="container mx-auto max-w-6xl space-y-6">
        ...
        <Card className="border-t-4 border-t-[#D32F2F] shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Lista de todos los requerimientos de obra pendientes de gestión.
            </CardDescription>
          </CardHeader>
                  ...
                  {solicitudes.map((solicitud) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        ...
                        <Dialog>
                          <DialogTrigger asChild>
                            ...
                            >
                              <Eye className="w-4 h-4" /> {solicitud.totalItems}{" "}
                              Items
                            </Button>
                          </DialogTrigger>
                          <DialogContent className="max-w-2xl bg-white">
                            <DialogHeader>
                              <DialogTitle className="flex justify-between items-center pr-8">
                                <span>
                                  Detalle Solicitud #{solicitud.folio}
                                </span>
                      ...
                      <td className="px-6 py-4 text-center">
                        <Badge
                          className={`${getStatusBadge(solicitud.estado)} text-white border-0`}
                        >
                          ...
                          {updatingId === solicitud.id ? (
                            ...
                            <Select
                              ...
                              disabled={
                                ...
                                solicitud.estado === "Rechazada" // Bloquear si ya terminó
                              }
                              onValueChange={(val) =>
                                handleStatusChange(solicitud.id, val)
                              }
                            >
