  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 pt-24 font-sans relative">
          ...
          <Card className="w-full max-w-sm shadow-2xl border-0 scale-100 animate-in zoom-in-95 duration-200">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription className="text-sm mt-2">
                Esta acción quitará el acceso al sistema a este usuario
                inmediatamente.
              </CardDescription>
            </CardHeader>
      ...
      <div className="container mx-auto max-w-6xl space-y-6">
            ...
            <Button
              className={
                editingId
                  ...
                  : "bg-[#D32F2F] hover:bg-red-700 gap-2"
              }
        ...
        {showCreateForm && (
          <Card
            className={`animate-in slide-in-from-top-4 border-l-4 ${editingId ? "border-l-blue-500" : "border-l-[#D32F2F]"}`}
          >
            <CardHeader>
              <CardTitle>
                {editingId
              ...
              <table className="w-full text-sm text-left">
                <thead className="text-slate-500 bg-slate-50 border-b">
                  <tr>
                    ...
                    <th className="h-12 px-4 font-medium align-middle text-right">
                      Acciones
                    </th>
                  </tr>
                </thead>
                <tbody className="[&_tr:last-child]:border-0">
                  {users.map((user) => (
                    <tr
                      key={user.id}
                      className={`border-b transition-colors hover:bg-slate-50/50 ${editingId === user.id ? "bg-blue-50" : ""}`}
                    >
                  ...
                  {users.length === 0 && !loading && (
                    <tr>
                      <td
                        colSpan={6}
                        className="p-4 text-center text-slate-500 h-24"
                      >
