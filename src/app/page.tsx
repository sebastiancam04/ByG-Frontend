        ...
        <div className="container px-4 md:px-6 mx-auto relative z-10">
          <div className="flex flex-col items-center text-center space-y-8 max-w-5xl mx-auto">
            <h1 className="animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100 text-5xl font-extrabold tracking-tight sm:text-6xl md:text-7xl lg:text-8xl text-white">
              ...
              <span className={`text-transparent bg-clip-text bg-gradient-to-r ${bgGradient}`}>
                Materiales
              </span>
            </h1>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#D32F2F] to-orange-700 px-6 py-20 text-center sm:px-12 md:py-28 shadow-2xl shadow-red-900/20">
            ...
            <div className="relative z-10 flex flex-col items-center gap-6 max-w-3xl mx-auto">
              ...
              <p className="text-white/90 text-lg md:text-xl max-w-xl leading-relaxed">
                Esta plataforma digitaliza el proceso de abastecimiento de ByG Ingeniería. 
                Permite a los trabajadores solicitar material de manera eficiente, limpia y con registro de sus pedidos.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-xl leading-relaxed text-gray-400">
                Entregamos soluciones tecnológicas para optimizar procesos industriales y energéticos.
              </p>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-[#333333] flex items-center justify-center hover:bg-[#D32F2F] transition-colors text-white">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link href="/" className="hover:text-[#D32F2F] transition-colors cursor-pointer flex items-center gap-2 group">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <span>Román Díaz 205, Oficina 102,<br/>Providencia, Santiago.</span>
                </li>
                <li className="flex items-center gap-3">
                    <Phone className="w-4 h-4 text-white" />
                  <span>+56 9 1234 5678 solicitar numero </span>
                </li>
                <li className="flex items-center gap-3">
                    <Mail className="w-4 h-4 text-white" />
                  <span className="hover:text-[#D32F2F] transition-colors">contacto@byg-ingenieria.cl</span>
                </li>
              </ul>
            </div>
          </div>
